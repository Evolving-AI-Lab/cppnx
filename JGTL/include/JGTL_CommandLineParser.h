...
namespace JGTL
{
	...
	class CommandLineParser : public _CommandLineParser
	{
	...
	public:
		...
		/*------------------------------------------------------
		int CommandLineParser::SplitLine(int argc, char **argv)
		...
		int         SplitLine(int argc, char **argv)
		{
			...
			{
				// if it's a switch, start a new CommandLineParser
				if (IsSwitch(argv[i]))
				{
					curParam = argv[i];
					...
					std::pair<CommandLineParser::iterator, bool> res = insert(CommandLineParser::value_type(curParam, cmd));
				...
				else
				{
					...
					// ...let's add it
					CommandLineParser::iterator theIterator;
		...
		/*------------------------------------------------------
		bool CommandLineParser::HasSwitch(const char *pSwitch)
		...
		StringType CommandLineParser::GetSafeArgument(const char *pSwitch, int iIdx, const char *pDefault)
		...
		StringType CommandLineParser::GetArgument(const char *pSwitch, int iIdx)
		...
		/*------------------------------------------------------
		int CommandLineParser::GetArgumentCount(const char *pSwitch)
