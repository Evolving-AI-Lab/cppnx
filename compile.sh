...
# Set NEAT
# Append to '-DNEAT_LIB=' to change the NEAT library (untested)
CMAKE_ARGUMENTS+="-DNEAT_INCLUDE=${NEAT_root}/include "
CMAKE_ARGUMENTS+="-DNEAT_LIB= "

# Set Tinyxml
# Append to '-DTINYXMLDLL_LIB=' to change the TinyXML-DLL library (untested)
CMAKE_ARGUMENTS+="-DTINYXMLDLL_INCLUDE=${tinyXML_root}/include "
CMAKE_ARGUMENTS+="-DTINYXMLDLL_LIB= "
...
# Set zlib
# Append to '-DZLIB_LIB=' to change the zlib library (untested)
CMAKE_ARGUMENTS+="-DZLIB_INCLUDE=${zlib_root} "
CMAKE_ARGUMENTS+="-DZLIB_LIB= "
